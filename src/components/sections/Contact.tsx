  ...
  return (
    <section id="contact" className="w-full py-12 md:py-24 lg:py-32 bg-background">
      <div className="container grid items-center justify-center gap-8 px-4 text-center md:px-6">
        ...
        <div className="mx-auto w-full max-w-lg animate-fade-in-up [animation-delay:0.2s]">
           <ContactForm />
        </div>
        <div className="flex justify-center items-center flex-col space-y-4 mt-8 animate-fade-in-up [animation-delay:0.4s]">
            <a
